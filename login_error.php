        ...
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p class="text-center text-muted"><a href="customer-register.html"><strong>Register now</strong></a>! It is easy and done in 1 minute and gives you extra salary and many more lol.</p>
            </div>
          </div>
        </div>
      </div>
     ...
     <div id="content">
        <div class="container">
          <div id="error-page" class="col-md-8 mx-auto text-center">
            <div class="box">
              <p class="text-center"><a href="index.php"><img src="img/logosekolah-small.png" alt="Obaju template"></a></p>
              <h3>We are sorry - Login Failed. Please try again.</h3>
              <h4 class="text-muted">Check your Caps Lock. This may cause problems logging in as passwords are case sensitive.</h4>
