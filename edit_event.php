  ...
  <body>
    <div id="all">
              ...
              <div class="d-flex justify-content-md-end justify-content-between">
				...
				<div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="homepage_admin.php" class="nav-link"><i class="fa fa-sign-out"></i> Logout</a></li>
                  </ul>
                </div>
      ...
      <!-- Navbar End-->
		...
		$query = "SELECT * FROM event where ev_id=$ev_id";
		$result = mysqli_query($conn,$query) or die('SQL error event');
		$row = mysqli_fetch_array($result, MYSQLI_ASSOC); 
		
	
		//to edit data
		if (isset($_POST['edit']) && isset($_POST['ev_id'])){
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2"><?php echo $row['ev_name']; ?></h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item"><a href="list_event.php">Event</a></li>
                <li class="breadcrumb-item active"><?php echo $row['ev_name']; ?></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            ...
            <tr>
              <th>EVENT ID</th>
              <td><input class="form-control" type="text" name="ev_id" value="<?php echo $row["ev_id"]; ?>"></td>
            </tr>

            <tr>
              <th>EVENT NAME</th>
              <td><input class="form-control" name="ev_name" value="<?php echo $row["ev_name"]; ?>"></td>
            </tr>

            <tr>
              <th>GUEST</th>
              <td><input class="form-control" type="text" name="ev_guest" value="<?php echo $row["ev_guest"]; ?>"></td>
            </tr>
             
             <tr>
              <th><label for="state_id">DATE</label></th>
              <td><input class="form-control" type="date" name="ev_date" value="<?php echo $row["ev_date"]; ?>"</td>
             </tr>
              
              <tr>
              	<th>PLACE</th>
              	<td><input class="form-control" type="text" name="ev_place" value="<?php echo $row["ev_place"]; ?>"></td>
              </tr>
              
              <tr>
              	<th>EVENT DESCRIPTION</th>
              	<td><input class="form-control" type="text" name="ev_desc" value="<?php echo $row["ev_desc"]; ?>"></td>
              </tr>
				  ...
				  <br><center><td><a href="info_event.php?ev_id=<?php echo $row['ev_id']; ?>" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
					...
					<li class="nav-item"><a href="list_event.php" class="nav-link active"><i class="fa fa-clock-o"></i> Events</a></li>
