  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		$result5 = mysqli_query($conn,$query5) or die('SQL error family');
          ...
          <div class="row bar">
            ...
            <tr>
             ...
             <tr>
				  ...
				  <center><td><a href="info_family.php?s_ic=<?php echo $row['s_ic']; ?>" class="btn btn-outline-dark">FAMILY BACKGROUND</a></td></center>
				  <center><td><a href="list_student.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
