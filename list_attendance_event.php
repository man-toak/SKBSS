...
<html>
  ...
  <body>
    ...
    $query = "SELECT ev_id, ev_name, ev_guest, ev_desc
         FROM event";
    ...
    ?>
        ...
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">List Attendance</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item active">List attendance</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
            ...
            <div id="customer-orders" class="col-md-9">
              ...
              <div class="box mt-0 mb-lg-0">
                <div class="table-responsive">
                   <form action="view_attendance_event.php" method="POST">
					<div align="center" class="container">
						<label for="ev_id">EVENT</label>
						<select class="form-control-lg-sm" id="ev_id" name="ev_id" required>
							 <option value=""></option>
          ...
          <?php } ?>
						...
						<br><br>
						<input class="btn btn-outline-primary" name="search" type="submit" value="search">
					   </div>
					 </form>
                </div>
              </div>
