	...
	//echo $s_ic;
        ...
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Family background</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item active">Family Backgound</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-order" class="col-lg-9">
              <p class="lead text-muted">If you have any questions, please feel free to <a href="contact.php">contact us</a>, our customer service center is working for you 24/7.</p>
                <div class="card">
                  <div id="headingOne" role="tab" class="card-header">
                    <h5 class="mb-0"><center><a data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed">FATHER</a></center></h5>
				...
				<TR>
					<td>NAME 	     :</td>
					<td><?php echo $row1['fam_fathername']; ?></td>
				</TR>
				<TR>
					<td>IC NUMBER    :</td>
					<td><?php echo $row1['fam_fatherIC']; ?></td>
				</TR>
				<TR>
					<td>JOB          :</td>
					<TD><?php echo $row1['fam_fatherjob']; ?></TD>
				</TR>
				<TR>
					<td>BIRTH DATE   :</td>
					<TD><?php echo $row1['fam_fatherbirthday']; ?></TD>
				</TR>
				<TR>
					<td>PHONE NUMBER :</td>
					<TD><?php echo $row1['fam_fatherphone']; ?></TD>
				</TR></table>
						</div>
                      </div>
                    </div>
				...
				<div class="card">
                  <div id="headingTwo" role="tab" class="card-header">
                    <h5 class="mb-0"><center><a data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">Mother</a></center></h5>
                  </div>
                    ...
                    <div class="card-body">
                      <div class="row">
						...
						<table class="table table-active"> 
                          <TR>
					<td>NAME 	:</td>
					<td><?php echo $row1['fam_mothername']; ?></td>
				</TR>
				<TR>
					<td>IC NUMBER :</td>
					<td><?php echo $row1['fam_motherIC']; ?></td>
				</TR>
				<TR>
					<td>JOB :</td>
					<TD><?php echo $row1['fam_motherjob']; ?></TD>
				</TR>
				<TR>
					<td>BIRTH DATE :</td>
					<TD><?php echo $row1['fam_motherbirthday']; ?></TD>
				</TR>
				<TR>
					<td>PHONE NUMBER :</td>
					<TD><?php echo $row1['fam_motherphone']; ?></TD>
				</TR>
							</table>
						</div>
                      </div>
				...
				<div class="card">
                  <div id="headingThree" role="tab" class="card-header">
                    <h5 class="mb-0"><center><a data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="collapsed">Siblings</a></center></h5>
                  </div>
                  <div id="collapseThree" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion" class="collapse">
					...
					<td><?php echo $row1['fam_numsibling']; ?></td>
					</TR></table>
                  	</table>
					</div>
					</div>
			  ...
			  <center>
				  <td><a href="edit_family.php?s_ic=<?php echo $row['s_ic']; ?>" class="btn btn-primary">EDIT FAMILY</a></td>
				  
				  <td><a href="info_student.php?s_ic=<?php echo $row['s_ic']; ?>" class="btn btn-outline-dark">CLOSE</a></td>
			  </center>
			</div>
