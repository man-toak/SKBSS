          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="info_teacher1.php?t_ic=<?php echo $t_ic ?>">Profile</a></li>
          ...
          <div class="row bar">
            ...
            <tr>
             ...
             <tr>
              ...
              <tr>
              	<th>EDUCATION</th>
              	<td><?php echo $row2['education_level']; ?></td>
              </tr>
              
              <tr>
              	<th>PHONE NUMBER</th>
              	<td><?php echo $row['t_nophone']; ?></td>
              </tr>
             ...
             <tr>
				  ...
				  <center><td><a href="edit_teacher1.php?t_ic=<?php echo $t_ic ?>" class="btn btn-outline-primary">EDIT</a></td></center>
				  <center><td><a href="homepage_teacher.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
