  ...
  <body>
	...
	<?php
		...
		<?php
			...
			$query = "SELECT form_name , (SELECT COUNT(form_id) FROM student WHERE a.form_id = form_id) AS percentage FROM form a WHERE form_id IN( SELECT form_id FROM student WHERE a.form_id = form_id) ORDER BY percentage DESC";
	  				...
	  				<div align="center">
    					...
    					<script type="text/javascript">
        				  ...
        				  var data = google.visualization.arrayToDataTable([
          					['FORM', 'PERCENTAGE OF STUDENTS', ],
          				<?php
						while ($row=$res->fetch_assoc())
						{
						  echo "['".$row['form_name']."',".$row['percentage']."],";
						}
						?>
						]);
						...
						var options = {
						  chart: {
							title: 'PERCENTAGE OF STUDENT BY FORM ',
