  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		$query = "SELECT state_name, (SELECT COUNT(state_id) FROM teacher WHERE a.state_id = state_id) AS percentage FROM state a WHERE state_id IN( SELECT state_id FROM teacher WHERE a.state_id = state_id) ORDER BY percentage DESC";
