...
<head>
  ...
  <body>
              ...
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">Contact <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-item"><a href="contact.php" class="nav-link">Contact option 2</a></li>
                    <li class="dropdown-item"><a href="contact.php" class="nav-link">Contact option 3</a></li>
                  </ul>
                </li>
	...
	<?php
		...
		$query = "SELECT education_level , (SELECT COUNT(educationID) FROM teacher WHERE a.educationID = educationID) AS percentage FROM education a WHERE educationID IN( SELECT educationID FROM teacher WHERE a.educationID = educationID) ORDER BY percentage DESC";
							...
							var data = google.visualization.arrayToDataTable([
							  ['Education level', 'Percentage'],
								<?php
									...
									{
									  echo "['".$row['education_level']."',".$row['percentage']."],";
									}
								?>
								]);

							var options = {
							  title: 'PERCENTAGE OF EDUCATION LEVEL AMONG TEACHER IN SMK BANDAR SUNWAY SEMENYIH',
							  pieHole: 0.4,
								};
