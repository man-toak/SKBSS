...
<html>
  ...
  <body>
    <div id="all">
      ...
      {
      	 $ac_date = addslashes($_POST['ac_date']);

      

      	 $query = "SELECT  `student`.* , `form`.* , `class`.* , `status_attendance`.* , `attendance_class`.*  FROM `attendance_class`
      	           INNER JOIN `student` ON `student`.`s_ic` = `attendance_class`.`s_ic` 
                   INNER JOIN `form` ON `form`.`form_id` = `attendance_class`.`form_id` 
                   INNER JOIN `class` ON `class`.`class_id` = `attendance_class`.`class_id`
                   INNER JOIN `status_attendance` ON `status_attendance`.`status_id` = `attendance_class`.`status_id`
      	           WHERE `attendance_class`.`ac_date` = '$ac_date' ";
          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="list_attendance.php">List Attendance</a></li>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar mb-0">
			...
			<center><br><br><td><a href="list_attendance.php" class="btn btn-template-outlined btn-sm">BACK</a></td></center>
            </div>
