...
<html>
  <head>
    ...
    <title>History Student Info</title>
  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		$query =  "SELECT * FROM history_student where hs_ic = $hs_ic";
        ...
        <?php //data state 
        if (isset($_GET['hs_ic'])) $hs_ic = $_GET['hs_ic'];
		else 
			$hs_ic = 0;
		...
		include 'dbconnect.php';
           ...
           $query1 = "SELECT t.*, st.* FROM state st, history_student t where t.state_id=st.state_id AND t.hs_ic =$hs_ic";
		...
		include 'dbconnect.php';
           ...
           $query3 = "SELECT t.*, g.* FROM gender g, history_student t where t.g_id=g.g_id AND t.hs_ic =$hs_ic";
		...
		include 'dbconnect.php';
           ...
           $query4 = "SELECT t.*, c.* FROM class c, history_student t where t.class_id=c.class_id AND t.hs_ic =$hs_ic";
		   $result4 = mysqli_query($conn,$query4) or die('SQL error gender');
		   $row4 = mysqli_fetch_array($result4, MYSQLI_ASSOC);
          ?>
	
		<?php //data form
        if (isset($_GET['hs_ic'])) $form_id = $_GET['hs_ic'];
		else 
			$hs_ic= 0;
		...
		include 'dbconnect.php';
           ...
           $query5 = "SELECT t.*, f.* FROM form f, history_student t where t.form_id=f.form_id AND t.hs_ic =$hs_ic";
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2"><?php echo $row['hs_name']; ?></h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item"><a href="history_student.php">Students History</a></li>
                <li class="breadcrumb-item active"><?php echo $row['hs_name']; ?></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            ...
            <tr>
              <th>IC NUMBER</th>
              <td><?php echo $row['hs_ic']; ?></td>
            </tr>

            <tr>
              <th>ADDRESS</th>
              <td><?php echo $row['hs_address']; ?></td>
            </tr>
             ...
             <tr>
              ...
              <tr>
                <th>AGE</th>
                <td><?php echo $row['hs_age']; ?></td>
              </tr>

              <tr>
              	<th>PHONE NUMBER</th>
              	<td><?php echo $row['hs_nophone']; ?></td>
              </tr>
              
              <tr>
              	<th>EMAIL</th>
              	<td><?php echo $row['hs_email']; ?></td>
              </tr>
             ...
             <tr>
				  ...
				  <center><td><a href="history_student.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
