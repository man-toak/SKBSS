          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box">
                ...
                <p class="text-muted">If you have any questions, please feel free to <a href="ontact.html">contact us</a>, our customer service center is working for you 24/7.</p>
                <hr>
                <form action="signup.php" method="post">
                  <div class="form-group">
                    <label for="user_id">User ID</label>
                    <input type="text" placeholder="user id" name="user_id" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label for="Username">Username</label>
                    <input type="text" placeholder="username" name="user_name" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label for="password-login">Password</label>
                    <input type="password" placeholder="Password" name="password1" class="form-control" required>
                  </div>
				  <div class="form-group">
                    <label for="password-login">Re-type Password (Confirmation)</label>
                    <input type="password" placeholder="Re-type Password" name="password2" class="form-control" required>
                  </div>
