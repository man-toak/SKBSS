            ...
            <div id="customer-orders" class="col-md-9">
              ...
              <div class="box mt-0 mb-lg-0">
                <div class="table-responsive">
                  <form class="form-control-lg" action="view_attendance_class.php" method="POST">
					<div align="center" class="container">
					<label for="ac_date">DATE</label>
					<input type="date" name="ac_date" required>
					<br>
					<input class="btn btn-outline-info" name="search" type="submit" value="search">
					</div>
				 </form>
                </div>
              </div>
