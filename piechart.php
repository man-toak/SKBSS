  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		$query = "SELECT g_type, (SELECT COUNT(g_id) FROM student WHERE a.g_id = g_id) AS percentage FROM gender a WHERE g_id IN( SELECT g_id FROM student WHERE a.g_id = g_id) ORDER BY percentage DESC";
	  				...
	  				<div align="center">
						...
						<script type="text/javascript">
						  ...
						  function drawChart() {
							...
							var options = {
							  title: 'PERCENTAGE OF GENDER AMONG STUDENT IN SMK BANDAR SUNWAY SEMENYIH'
								};
