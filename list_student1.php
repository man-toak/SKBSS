          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="list_student1.php">Students</a></li>
        ...
        <div class="container">
          <div class="row bar mb-0">
            <div id="customer-order" class="col-lg-9">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
					...
					<tr>
						...
						<td><a href="info_student1.php?s_ic=<?php echo $row['s_ic']; ?>" class="btn btn-template-outlined btn-sm">VIEW</a></td>
						<td><a href="edit_student1.php?s_ic=<?php echo $row['s_ic']; ?>" class="btn btn-template-outlined btn-sm">EDIT</a></td>
						<td><a href="" class="btn btn-template-outlined btn-sm delete" data-action="delete" data-body-message="Are you sure to delete this data?" data-redirect-url="delete_student1.php?s_ic=<?php echo $row['s_ic']; ?>">DELETE</a></td>
					</tr>
					<?php 
					}
					?> 
              ...
              <center><br><br><td><a href="registration_student1.php" class="btn btn-template-outlined btn-sm">ADD STUDENT</a></td></center>
            </div>
