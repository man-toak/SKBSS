        ...
        <div class="container">
          <div class="row bar mb-0">
              ...
              <div class="box mt-0 mb-lg-0">
                <div class="table-responsive">
    				...
    				<div>
     					...
     					<input type="text" name="search_text" id="search_text" placeholder="Search by Teacher Details" class="form-control" />
    				</div>
   					</div>
					<div id="result"></div>
					<!--Live search AIMAN end -->
                </div>
				  <center><br><td><a href="registration_teacher.php" class="btn btn-template-outlined btn-sm">ADD TEACHER</a></td></center>
              </div>	
            </div>
            <div class="col-lg-3 mt-4 mt-lg-0">
              ...
              <br><td class="nav-item"><a href="history_teacher.php" class="btn btn-secondary"><i class="fa fa-history"></i> Teachers History</a></td>
			</div>
          </div>
        </div>
      </div>
