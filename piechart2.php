  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		$query = "SELECT g_type,  (SELECT COUNT(g_id) FROM teacher WHERE a.g_id = g_id) AS percentage FROM gender a WHERE g_id IN( SELECT g_id FROM teacher WHERE a.g_id = g_id) ORDER BY percentage DESC";
						  ...
						  function drawChart() {
							...
							var data = google.visualization.arrayToDataTable([
							 ...
							 <?php
								...
								{
								  echo "['".$row['g_type']."',".$row['percentage']."],";
								}
							 ?>
								]);

							var options = {
							  title: 'PERCENTAGE OF GENDER AMONG TEACHERS IN SMK BANDAR SUNWAY SEMENYIH'
								};
