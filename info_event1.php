          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="list_event1.php">Event</a></li>
          ...
          <div class="row bar">
			...
			<tr>
      		...
      		<tr>
         		<th>DESCRIPTION</th>
				  ...
				  <center><td><a href="list_event1.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
            <div class="col-lg-3 mt-4 mt-lg-0">
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="list_teacher1.php" class="nav-link"><i class="fa fa-list"></i>Profile</a></li>
                    <li class="nav-item"><a href="list_student1.php" class="nav-link"><i class="fa fa-heart"></i> Students</a></li>
					<li class="nav-item"><a href="list_event1.php" class="nav-link active"><i class="fa fa-clock-o"></i> Events</a></li>
