...
<html>
  <head>
    ...
    <title>History of Student</title>
  ...
  <body>
    <div id="all">
      ...
      <?php
        ...
        $query = 'SELECT  hs_ic,hs_name from history_student';
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Students History</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item active">Students History</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div id="customer-orders" class="col-md-9">
              ...
              <div class="box mt-0 mb-lg-0">
                <div class="table-responsive">
                      ...
                      ?>
                        <tr>
                          <th><?php echo $row['hs_ic']; ?></th>
                          <td><?php echo $row['hs_name']; ?></td>
                          <td><a href="info_history_student.php?hs_ic=<?php echo $row['hs_ic']; ?>" class="btn btn-outline-primary">VIEW</a></td>
                          <td><a href="" class="btn btn-outline-primary recover" data-action="recover" data-body-message="Are you sure to recover this data?" data-redirect-url="student_restore.php?hs_ic=<?php echo $row['hs_ic']; ?>">RECOVER</a></td>
                          <td><a href="" class="btn btn-outline-danger delete" data-action="delete" data-body-message="Are you sure to permanently delete this data?" data-redirect-url="delete_history_student.php?hs_ic=<?php echo $row['hs_ic']; ?>">DELETE</a></td>
                        </tr>
                        <?php 
                        }
                      ?>
