		...
		<?php 
             ...
             if (isset($_POST['add'])){
              ...
              $class_id = addslashes($_POST['class_id']);
				 ...
				 $query4="SELECT * FROM `attendance_class` WHERE  `s_ic`='$s_ic' AND `ac_date`='$ac_date'";
				 ...
				 if(mysqli_num_rows($result4)>0)
				 {
					 echo "<script language='javascript' type='text/javascript'>";
			   		...
			   		echo "</script>";
			   		$url ="attendance_student1.php?t_ic='$t_ic'";
			   		echo "<script>location.href='$url' </script>";
				 }
				 
				 else
				 {
					    $query2= "INSERT INTO `attendance_class`(`s_ic`, `form_id`, `class_id`, `ac_date`, `status_id`) VALUES ('$s_ic', '$form_id', '$class_id' , '$ac_date', '$status_id')";
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Attendance Students</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_teacher.php">Home</a></li>
                <li class="breadcrumb-item active">Attendance Students</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row bar mb-0">
			...
			<tr>
				...
				<td><input type="date" name="ac_date" value="ac_date"></td>

				<td><input type="radio" name="status_id" value="1">ATTEND 
					<input type="radio" name="status_id" value="2">ABSENT
				</td>
				<td><input class="btn btn-outline-info" id="submit" name="add" type="submit" value="Submit"></td>
        		</form>
