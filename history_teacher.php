...
<html>
  <head>
    ...
    <title>History of Teacher</title>
  ...
  <body>
    <div id="all">
      ...
      <?php
        ...
        $query = 'SELECT  ht_ic,ht_name from history_teacher';
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Teachers History</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item active">Teachers History</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div id="customer-orders" class="col-md-9">
              ...
              <div class="box mt-0 mb-lg-0">
                <div class="table-responsive">
                      ...
                      ?>
                        <tr>
                          <th><?php echo $row['ht_ic']; ?></th>
                          <td><?php echo $row['ht_name']; ?></td>
                          <td><a href="info_history_teacher.php?ht_ic=<?php echo $row['ht_ic']; ?>" class="btn btn-outline-primary">VIEW</a></td>
                          <td><a href="" class="btn btn-outline-primary recover" data-action="recover" data-body-message="Are you sure to recover this data?" data-redirect-url="teacher_restore.php?ht_ic=<?php echo $row['ht_ic']; ?>">RECOVER</a></td>
                          <td><a href="" class="btn btn-outline-danger delete" data-action="delete" data-body-message="Are you sure to permanently delete this data?" data-redirect-url="delete_history_teacher.php?ht_ic=<?php echo $row['ht_ic']; ?>">DELETE</a></td>
                        </tr>
                        <?php 
                        }
                      ?>
