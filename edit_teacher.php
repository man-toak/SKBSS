  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		//to edit data
		if (isset($_POST['edit']) && isset($_POST['t_ic'])) {
			...
			{	echo "<script type='text/javascript'>alert('UPDATE SUCCESS')</script>";
			 	//header("Location: list_teacher.php?hr_id={$rowA['hr_id']}");
			}
			else
	...
	?>
      ...
      <?php
		...
		if (isset($_GET['hr_id']))
			...
			$hr_id = 0;
		include 'dbconnect.php';
		$queryA= "SELECT * FROM hr  where hr_id = $hr_id";
		$resultA = mysqli_query($conn,$queryA) or die('SQL error admin');
		...
		$query11 = "SELECT t.*, s.* FROM state s, teacher t where t.state_id=s.state_id AND t.t_ic=$t_ic";
		$result11 = mysqli_query($conn,$query11) or die('SQL error state');
	  ...
	  <?php 
		...
		$query33 = "SELECT t.*, g.* FROM gender g, teacher t where t.g_id=g.g_id AND t.t_ic=$t_ic";
	  ...
	  <?php 
		...
		$query44 = "SELECT t.*, c.* FROM class c, teacher t where t.class_id=c.class_id AND t.t_ic=$t_ic";
	  ...
	  <?php 
		...
		$result4 = mysqli_query($conn,$query4) or die('SQL error class 1');
          ?>
	...
	<?php 
		...
		$query55 = "SELECT t.*, f.* FROM form f, teacher t where t.form_id=f.form_id AND t.t_ic=$t_ic";
	  ...
	  <?php 
		...
		$query66 = "SELECT t.*, e.* FROM education e, teacher t where t.educationID=e.educationID AND t.t_ic=$t_ic";
		$result66 = mysqli_query($conn,$query66) or die('SQL error education');
	  ...
	  <?php 
		...
		$result6 = mysqli_query($conn,$query6) or die('SQL error education 1');
          ?>
          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="list_teacher.php">Teacher</a></li>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            ...
            <tr>
              <th>ADDRESS</th>
              <td><textarea class="form-control" type="text"  name="t_address" value="<?php echo $row['t_address']; ?>"> <?php echo $row['t_address']; ?></textarea></td>
            </tr>
             ...
             <tr>
              ...
              <tr>
              	...
              	<td><select class="form-control" id="educationID" name="educationID">
      					<option value="<?php echo ($row66['educationID']); ?>" hidden><?php echo ($row66['education_level']); ?></option>
						<?php while ($row6=mysqli_fetch_array($result6,MYSQLI_ASSOC)){ ?>
						<option value="<?php echo $row6['educationID']; ?>" ><?php echo $row6['education_level']; ?></option>
						<?php } ?>
    				</select></td>
              </tr>
              ...
              <tr>
              	 <th>FORM</th>
              	 <td><select class="form-control" id="form_id" name="form_id" value="<?php echo $row['form_id']; ?>">
             ...
             <tr>
				  ...
				  <br><center><td><a href="list_teacher.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="list_teacher.php" class="nav-link active"><i class="fa fa-list"></i> Teacher</a></li>
