...
<head>
  ...
  <body>
    ...
    $result = mysqli_query($conn,$query) or die('SQL error admin');
	  ...
	  <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Hi admin, <?php echo $row['user_name']; ?></h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item active">id : <?php echo $row['user_id']; ?></li>
              </ul>
            </div>
          </div>
        </div>
