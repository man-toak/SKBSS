          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="info_student1.php?t_ic=<?php echo $s_ic ?>">Student</a></li>
          ...
          <div class="row bar">
            <div id="customer-order" class="col-lg-9">
              ...
              <div class="card">
				...
				<TR>
					<td>NAME 	     :</td>
					<td><?php echo $row['fam_fathername']; ?></td>
				</TR>
				<TR>
					<td>IC NUMBER    :</td>
					<td><?php echo $row['fam_fatherIC']; ?></td>
				</TR>
				<TR>
					<td>JOB          :</td>
					<TD><?php echo $row['fam_fatherjob']; ?></TD>
				</TR>
				<TR>
					<td>BIRTH DATE   :</td>
					<TD><?php echo $row['fam_fatherbirthday']; ?></TD>
				</TR>
				<TR>
					<td>PHONE NUMBER :</td>
					<TD><?php echo $row['fam_fatherphone']; ?></TD>
				</TR></table>
						</div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
						...
						<table class="table table-active"> 
                          <TR>
					<td>NAME 	:</td>
					<td><?php echo $row['fam_mothername']; ?></td>
				</TR>
				<TR>
					<td>IC NUMBER :</td>
					<td><?php echo $row['fam_motherIC']; ?></td>
				</TR>
				<TR>
					<td>JOB :</td>
					<TD><?php echo $row['fam_motherjob']; ?></TD>
				</TR>
				<TR>
					<td>BIRTH DATE :</td>
					<TD><?php echo $row['fam_motherbirthday']; ?></TD>
				</TR>
				<TR>
					<td>PHONE NUMBER :</td>
					<TD><?php echo $row['fam_motherphone']; ?></TD>
				</TR>
							</table>
						</div>
                      </div>
				...
				<div class="card">
                  ...
                  <div id="collapseThree" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion" class="collapse">
					...
					<td><?php echo $row['fam_numsibling']; ?></td>
					</TR></table>
					</table>
					</div>
					</div>
