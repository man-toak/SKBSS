...
<html>
  <head>
    ...
    <title>History Teacher Info</title>
  ...
  <body>
    <div id="all">
      ...
      <!-- Navbar End-->
		...
		$query =  "SELECT * FROM history_teacher  where ht_ic = $ht_ic";
		$result = mysqli_query($conn,$query) or die('SQL error sini');
		$row = mysqli_fetch_array($result, MYSQLI_ASSOC)
		?>
	
		
        <?php //data state 
        if (isset($_GET['ht_ic'])) $ht_ic = $_GET['ht_ic'];
		else 
			$ht_ic = 0;
		...
		include 'dbconnect.php';
           ...
           $query1 = "SELECT t.*, st.* FROM state st, history_teacher t where t.state_id=st.state_id AND t.ht_ic =$ht_ic";
		...
		include 'dbconnect.php';
           ...
           $query2 = "SELECT t.*, e.* FROM education e, history_teacher t where t.educationID=e.educationID AND t.ht_ic =$ht_ic";
		...
		include 'dbconnect.php';
           ...
           $query3 = "SELECT t.*, g.* FROM gender g, history_teacher t where t.g_id=g.g_id AND t.ht_ic =$ht_ic";
		...
		include 'dbconnect.php';
           ...
           $query4 = "SELECT t.*, c.* FROM class c, history_teacher t where t.class_id=c.class_id AND t.ht_ic =$ht_ic";
		   $result4 = mysqli_query($conn,$query4) or die('SQL error gender');
		   $row4 = mysqli_fetch_array($result4, MYSQLI_ASSOC);
          ?>
	
		<?php //data form
        if (isset($_GET['ht_ic'])) $form_id = $_GET['ht_ic'];
		else 
			$ht_ic= 0;
		...
		include 'dbconnect.php';
           ...
           $query5 = "SELECT t.*, f.* FROM form f, history_teacher t where t.form_id=f.form_id AND t.ht_ic =$ht_ic";
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2"><?php echo $row['ht_name']; ?></h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="homepage_admin.php">Home</a></li>
                <li class="breadcrumb-item"><a href="history_teacher.php">Teachers History</a></li>
                <li class="breadcrumb-item active"><?php echo $row['ht_name']; ?></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            ...
            <tr>
              <th>IC NUMBER</th>
              <td><?php echo $row['ht_ic']; ?></td>
            </tr>

            <tr>
              <th>ADDRESS</th>
              <td><?php echo $row['ht_address']; ?></td>
            </tr>
             ...
             <tr>
              ...
              <tr>
              	<th>PHONE NUMBER</th>
              	<td><?php echo $row['ht_nophone']; ?></td>
              </tr>
              
              <tr>
              	<th>EMAIL</th>
              	<td><?php echo $row['ht_email']; ?></td>
              </tr>
             ...
             <tr>
				  ...
				  <center><td><a href="history_teacher.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
