...
<html>
  ...
  <body>
	...
	<?php  
		...
		include 'dbconnect.php';
		$query7 = "SELECT * FROM teacher  where t_ic = $t_ic";
		$result7 = mysqli_query($conn,$query7) or die('SQL error teacher ');
          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="list_student1.php">Student</a></li>
				  <li class="breadcrumb-item"><a href="edit_student1.php">Edit</a></li>
          ...
          <div class="row bar">
            ...
            <tr>
             ...
             <tr>
				  ...
				  <br><center><td><a href="list_student1.php" class="btn btn-dark">CLOSE</a></td></center>
              </div>
            </div>
